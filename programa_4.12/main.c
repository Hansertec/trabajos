...
➥ de N1 y N2. */
while ((N1 % I)||(N2 % I)) /* El ciclo se mantiene activo mientras (N1 % I) o (N2 % I) sean ➥ distintos de cero. Cuando el resultado de la evaluación sea 0, el ➥ ciclo se detiene ya que se habrá encontrado el máximo común divisor. */ I--;
return I;
}
